  ...
  var generateSimilarWizards = function () {
    ...
    for (var i = 0; i <= WIZARDS_COUNT; i++) {
      var randomWizard = {
        ...
        coatColor: window.util.getRandomArrayElement(window.setup.WIZARD_COAT_COLORS),
        eyesColor: window.util.getRandomArrayElement(window.setup.WIZARD_EYES_COLORS)
      };
